...
def perform_calculations():
    ...
    if pizza_size == PIZZA_SIZE[0]:
        cost_pizza = pizza_amt * PIZZA_PRICE[0]
    elif pizza_size == PIZZA_SIZE[1]:
        cost_pizza = pizza_amt * PIZZA_PRICE[1]    
    elif pizza_size == PIZZA_SIZE[2]:
        cost_pizza = pizza_amt * PIZZA_PRICE[2]    
    elif pizza_size == PIZZA_SIZE[3]:
        cost_pizza = pizza_amt * PIZZA_PRICE[3]   
